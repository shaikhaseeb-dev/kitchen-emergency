...
export default function Hero() {
  ...
  return (
    <section id="hero" ref={heroRef} style={{
      minHeight: '100vh',
      background: 'linear-gradient(160deg, #fff8f3 0%, #ffffff 55%, #fef9f6 100%)',
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(232,93,4,0.07) 0%, transparent 65%)', pointerEvents: 'none',
      }} />
      <div style={{
        position: 'absolute', bottom: -80, left: -80, width: 380, height: 380, borderRadius: '50%',
        background: 'radial-gradient(circle, rgba(232,93,4,0.04) 0%, transparent 70%)', pointerEvents: 'none',
      }} />
        ...
        <div style={{
          ...
          <div>
            ...
            <p className="hero-animate" style={{
              ...
              color: '#6b7280', lineHeight: 1.8, marginBottom: 12, maxWidth: 490,
            }}>
              We understand how stressful it is when cooking suddenly stops — especially with family at home.
            </p>
            <p className="hero-animate" style={{
              fontSize: '0.93rem', color: '#9ca3af', lineHeight: 1.75, marginBottom: 36, maxWidth: 490,
            }}>
              We're a small coordination team. We look for available cooking solutions near you and help arrange them. <em>No promises we can't keep — just genuine effort to help.</em>
            </p>

            <div className="hero-animate" style={{ display: 'flex', flexWrap: 'wrap', gap: 14 }}>
              <a href="#contact" style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
                background: 'linear-gradient(135deg, #e85d04, #c94b00)',
                color: 'white', padding: '15px 30px', borderRadius: 14,
                ...
                onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(232,93,4,0.3)'; }}
              >🆘 Request Help</a>
              ...
              <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${WHATSAPP_MSG}`}
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = '#25D366'; e.currentTarget.style.color = '#16a34a'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = '#e5e7eb'; e.currentTarget.style.color = '#1f2937'; e.currentTarget.style.transform = 'translateY(0)'; }}
              ><span style={{ fontSize: '1.1rem' }}>💬</span> Chat on WhatsApp</a>
            </div>

            <div className="hero-animate" style={{
              marginTop: 26, display: 'flex', alignItems: 'center', gap: 22, flexWrap: 'wrap',
            }}>
              {['🤝 We arrange, not sell', '📍 Local solutions', '🔒 No hidden charges'].map(t => (
                <span key={t} style={{ fontSize: '0.8rem', color: '#bcc3cc', fontWeight: 500 }}>{t}</span>
              ))}
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div style={{
              ...
              boxShadow: '0 16px 50px rgba(0,0,0,0.09), 0 3px 12px rgba(232,93,4,0.07)',
              ...
              <div style={{ textAlign: 'center', marginBottom: 22 }}>
                ...
                <h3 style={{
                  ...
                  fontSize: '1rem', color: '#111827', marginBottom: 3,
                }}>HomeAssist India</h3>
                <p style={{ fontSize: '0.78rem', color: '#9ca3af' }}>Kitchen Emergency Support</p>
              </div>
              ...
              {[
                ...
                <div key={item.text} style={{
                  ...
                  <span style={{ fontSize: '0.84rem', color: '#4b5563', lineHeight: 1.55 }}>{item.text}</span>
                </div>
              ))}

              <div style={{ marginTop: 16, textAlign: 'center', fontSize: '0.74rem', color: '#d1d5db' }}>
